...
adi_project ad9082_fmca_ebz_iwave_zu11 0 [list \
  ...
  REF_CLK_RATE [get_env_param REF_CLK_RATE   562.5 ] \
  RX_PLL_SEL   [get_env_param RX_PLL_SEL     2 ] \
  TX_PLL_SEL   [get_env_param TX_PLL_SEL     2 ] \
  RX_LANE_RATE [get_env_param RX_LANE_RATE      18.5625 ] \
  TX_LANE_RATE [get_env_param TX_LANE_RATE      18.5625 ] \
...
adi_project_files ad9082_fmca_ebz_iwave_zu11 [list \
  "../../ad9081_fmca_ebz/iwave_zu11/system_top.v" \
  "../../ad9081_fmca_ebz/iwave_zu11/system_constr.xdc" \
  "./timing_constr.xdc" \
  "../../../library/common/ad_3w_spi.v" \
  "$ad_hdl_dir/library/common/ad_iobuf.v" \
  "$ad_hdl_dir/projects/common/iwave_zu11/iwave_zu11_system_constr.xdc" ]


adi_project_run ad9082_fmca_ebz_iwave_zu11
