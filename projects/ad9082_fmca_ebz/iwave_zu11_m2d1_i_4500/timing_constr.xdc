...
## 562.5 MHz
#create_clock -name refclk         -period  1.7773 [get_ports fpga_refclk_in_p]
# 281.25
create_clock -name refclk         -period  3.5547 [get_ports fpga_refclk_in_p]

# device clock
# 281.25 MHz
create_clock -name tx_device_clk     -period  3.5547 [get_ports clkin6_p]
create_clock -name rx_device_clk     -period  3.5547 [get_ports clkin10_p]
...
# For transceiver output clocks use reference clock // [NOT] divided by two
