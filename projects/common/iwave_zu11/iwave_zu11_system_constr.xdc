...
# These signals go through 3.3V level shifters
set_property  -dict {PACKAGE_PIN  B16  IOSTANDARD LVCMOS18} [get_ports gpio_bd_o[0]]           ; ## GPIO_PMOD1_1
set_property  -dict {PACKAGE_PIN  A18  IOSTANDARD LVCMOS18} [get_ports gpio_bd_o[1]]           ; ## GPIO_PMOD1_2
set_property  -dict {PACKAGE_PIN  A13  IOSTANDARD LVCMOS18} [get_ports gpio_bd_o[2]]           ; ## GPIO_PMOD1_3
set_property  -dict {PACKAGE_PIN  B15  IOSTANDARD LVCMOS18} [get_ports gpio_bd_o[3]]           ; ## GPIO_PMOD1_4
set_property  -dict {PACKAGE_PIN  C16  IOSTANDARD LVCMOS18} [get_ports gpio_bd_o[4]]           ; ## GPIO_PMOD1_7
set_property  -dict {PACKAGE_PIN  B18  IOSTANDARD LVCMOS18} [get_ports gpio_bd_o[5]]           ; ## GPIO_PMOD1_8
set_property  -dict {PACKAGE_PIN  A14  IOSTANDARD LVCMOS18} [get_ports gpio_bd_o[6]]           ; ## GPIO_PMOD1_9
set_property  -dict {PACKAGE_PIN  C15  IOSTANDARD LVCMOS18} [get_ports gpio_bd_o[7]]           ; ## GPIO_PMOD1_10
